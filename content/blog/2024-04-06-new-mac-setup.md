...
* install main apps
  ...
  * install apps (~5 mins)
    ...
    * `brew install iterm2 visual-studio-code textbar arc alfred inkscape blender spotify 1password slack postgres-unofficial rocket element discord dockutil`
